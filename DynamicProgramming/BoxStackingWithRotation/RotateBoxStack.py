...
def maxStackHeight(arr, n):
    ...
    #     For example, for a box {1, 2, 3}, 
    #     we consider three instances{{1, 2, 3}, {2, 1, 3}, {3, 1, 2}}
...
if __name__ == "__main__":
    ...
    arr = [Box(5, 2, 1), Box(2, 5, 3), Box(4, 5, 1),
            Box(3, 4, 1), Box(2, 1, 2), Box(4, 1, 2),
            Box(5, 3, 3), Box(4, 1, 5), Box(2, 2, 4)]
    n = len(arr)
    print("The maximum possible height of stack is",
           maxStackHeight(arr, n))